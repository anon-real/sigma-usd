...
export function bankbox_able_to_mint_stablecoin_amount(a: number, b: number, c: number, d: number): number;
export function bankbox_num_able_to_mint_stablecoin(a: number, b: number, c: number): void;
export function bankbox_mint_stablecoin_reserve_ratio(a: number, b: number, c: number, d: number, e: number): void;
export function bankbox_able_to_mint_reservecoin_amount(a: number, b: number, c: number, d: number, e: number, f: number): number;
export function bankbox_num_able_to_mint_reservecoin(a: number, b: number, c: number, d: number, e: number): void;
export function bankbox_mint_reservecoin_reserve_ratio(a: number, b: number, c: number, d: number, e: number): void;
export function bankbox_able_to_redeem_reservecoin_amount(a: number, b: number, c: number, d: number): number;
export function bankbox_num_able_to_redeem_reservecoin(a: number, b: number, c: number): void;
export function bankbox_redeem_reservecoin_reserve_ratio(a: number, b: number, c: number, d: number, e: number): void;
